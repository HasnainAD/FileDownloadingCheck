...
public class InboxActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(InboxActivity.this, InboxFilesActivity.class);
    ...
    protected void onResume() {
        ...
        if (Utils.profile != null) {
            ...
            if (!Utils.profile.getProfilePhotoUrl().equals("empty")) {
                ...
                Glide.with(InboxActivity.this).load(Utils.profile.getProfilePhotoUrl()).apply(RequestOptions.circleCropTransform()).into(profileImage);
            }
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_inbox) {
            ...
            Intent intent = new Intent(InboxActivity.this, ShareActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        } else if (id == R.id.nav_uploaded) {
            Intent intent = new Intent(InboxActivity.this, UploadActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        }
        else if (id == R.id.nav_profile) {
            Intent intent = new Intent(InboxActivity.this, Profile_Activity.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(InboxActivity.this, HelpActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
